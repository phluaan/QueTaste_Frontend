...
const ProductCard = ({ p }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition duration-150 hover:shadow-2xl hover:scale-105 flex flex-col">
      {/* Ảnh + link */}
      ...
      <div className="p-3 border-t">
        <button
          ...
          className="w-full bg-primary text-white text-sm py-2 rounded-lg hover:bg-opacity-90 transition"
        >
          Thêm vào giỏ hàng
        </button>
      </div>
