        ...
        <>
          <div className="flex items-center justify-between mb-3">
            <div className="text-sm text-gray-500">
              ...
              {q && (
                <span className="ml-2 text-gray-400">(lọc theo: “{q}”)</span>
              )}
            </div>
          </div>
          ...
          {filtered && filtered.length > 0 ? (
            ...
            <div className="bg-white rounded-2xl border border-dashed border-gray-2 00 p-10 text-center text-gray-500">
