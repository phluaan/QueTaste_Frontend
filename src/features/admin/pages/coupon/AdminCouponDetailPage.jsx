      ...
      <div className="max-w-5xl mx-auto bg-white shadow rounded-lg p-8">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-4 text-gray-700 bg-gray-50 rounded-lg p-6 border">
            ...
            <p>
              <span className="font-medium">Tên:</span> {couponDetail.name}
            </p>
            <p>
            ...
            <p>
              <span className="font-medium">Loại:</span> {couponDetail.type}
            </p>
            <p>
              <span className="font-medium">Đã dùng:</span>{" "}
              {couponDetail.usedCount} /{" "}
              {couponDetail.usageLimit || "Không giới hạn"}
            </p>
            <p>
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              >
                <option value="public">
                  🌍 Public (mọi người có thể dùng mã)
                </option>
                <option value="private">
                  🔒 Private (chỉ cấp phát cho user qua UserCoupon)
                </option>
              </select>
            </div>
