      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="relative z-50" onClose={onClose}>
          ...
          <div className="fixed inset-0 flex items-center justify-center p-4">
            ...
            >
              <Dialog.Panel className="w-full max-w-3xl rounded-2xl bg-que-surface p-6 shadow-xl relative">
                {/* Close button */}
                <button
                ...
                {/* Header */}
                <Dialog.Title className="text-2xl font-semibold mb-4 border-b pb-2 text-que-text-main">
